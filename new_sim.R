...
for(i in 1:length(S_vec)){
 ...
 # save(data_list, file = paste0("/mnt/workspace/Gjammod/sim_med/data/DS_S_",S_vec[i],"_q_",q,"_n_500_",Ktr,".Rda"))
  ...
  for(j in 1:length(r_vec)){
    ...
    save(list, file =paste0("/mnt/workspace/Gjammod/sim_med/ODSim_smallS",S_vec[i],"K10_gjam.Rda"))
    ########gjam 0  model list########################
    l00<-list()
    ...
    save(list0, file = paste0("/mnt/workspace/Gjammod/sim_med/ODSim_smallS",S_vec[i],"K10_gjam0.Rda"))
    ########gjam 1  model list######################## 
    l2<-list()
    ...
    save(list2, file = paste0("/mnt/workspace/Gjammod/sim_med/ODSim_smallS",S_vec[i],"K10_type1.Rda"))
    ########gjam 2  model list########################    
    l3<-list()
    ...
    save(list3, file = paste0("/mnt/workspace/Gjammod/sim_med/ODSim_smallS",S_vec[i],"K10_type2.Rda"))
    ########gjam 3  model list########################    
    l4<-list()
    ...
    save(list4, file = paste0("/mnt/workspace/Gjammod/sim_med/ODSim_smallS",S_vec[i],"K10_type3.Rda"))
    ########gjam 4  model list########################    
    l5<-list()
    ...
    save(list5, file = paste0("/mnt/workspace/Gjammod/sim_med/ODSim_smallS",S_vec[i],"K10_type4.Rda"))
    k=k+1
  }
