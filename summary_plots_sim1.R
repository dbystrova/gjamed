...
for(i in (1: nrow(table_comp))){
  ...
  if((table_comp$mod[i]=="gjam")&(length(grep(paste0("r_",table_comp$rv[i]),names(Ltgj0)[j]))>0)){ table_comp$lweight[i]<- apply(Ltgj0[[j]]$pk_chain[-c(1:burn),],2,mean)[length(apply(Ltgj0[[j]]$pk_chain,2,mean))]}
  if((table_comp$mod[i]=="gjam1")&(length(grep(paste0("r_",table_comp$rv[i]),names(LtT1)[j]))>0)){ table_comp$lweight[i]<-  apply(LtT1[[j]]$pk_chain[-c(1:burn),],2,mean)[length(apply(LtT1[[j]]$pk_chain,2,mean))]}
  if((table_comp$mod[i]=="gjam2")&(length(grep(paste0("r_",table_comp$rv[i]),names(LtT2)[j]))>0)){ table_comp$lweight[i]<- apply(LtT2[[j]]$pk_chain[-c(1:burn),],2,mean)[length(apply(LtT2[[j]]$pk_chain,2,mean))]}
  if((table_comp$mod[i]=="gjam3")&(length(grep(paste0("r_",table_comp$rv[i]),names(LtT3)[j]))>0)){ table_comp$lweight[i]<-  apply(LtT3[[j]]$pk_chain[-c(1:burn),],2,mean)[length(apply(LtT3[[j]]$pk_chain,2,mean))]}
  if((table_comp$mod[i]=="gjam4")&(length(grep(paste0("r_",table_comp$rv[i]),names(LtT4)[j]))>0)){ table_comp$lweight[i]<- apply(LtT4[[j]]$pk_chain[-c(1:burn),],2,mean)[length(apply(LtT4[[j]]$pk_chain,2,mean))]}
}
